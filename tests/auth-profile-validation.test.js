...
(async () => {
    ...
    current = snapshot({ accountCode: "TTEACH1", role: "teacher", active: true });
    result = await getProfile({ uid: "teacher-uid", email: "tteach1@accounts.invalid" }, { expectedAccountCode: "TTEACH1", throwOnInvalid: true });
